...
import { Eye, Save, ArrowLeft, Upload, Send } from 'lucide-react';
...
interface GeneralPreConsultFormProps {
  onBack: () => void;
  onPreview: (data: GeneralPreConsultData) => void;
  onSave?: () => void;
...
export interface GeneralPreConsultData {
  contactName: string;
  contactEmail: string;
...
export function GeneralPreConsultForm({ onBack, onPreview, onSave, backButtonLabel = "Save & Back", services, linkedService }: GeneralPreConsultFormProps) {
  ...
  const defaultTitle = 'Pre-Consultation Questionnaire';
  const defaultSubtitle = 'Preliminary Consultation';
    ...
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-4xl mx-auto">
        <RefinedHeader
          ...
          onBack={onBack}
          backButtonLabel={backButtonLabel || 'Back to Flow Wizard'}
        />
        <div className="py-8">
          <div className="space-y-8">
            {/* Personalization Section - For consultant to fill out */}
            <Card className="p-8 border-2 border-[#2f829b] rounded-xl bg-[#f5fafb]">
              <h2 className="font-['Lora'] text-2xl text-[#034863] mb-4">
                Personalize This Questionnaire
              </h2>
              <p className="font-['Poppins'] text-sm text-[#034863]/70 mb-6">
                Optional: Add a custom title to personalize this questionnaire for your prospect. Leave blank to use the default title.
              </p>
              
              <div className="space-y-4 bg-white p-6 rounded-lg border border-[#ddecf0]">
                <div>
                  <label className="block font-['Poppins'] text-[16px] text-[#034863] mb-2 font-medium">
                    Custom Title
                  </label>
                  <Input
                    value={customTitle}
                    onChange={(e) => setCustomTitle(e.target.value)}
                    placeholder="e.g., Memorial Hospital - Discovery Call"
                    className="font-['Poppins'] text-[18px] text-[rgb(0,0,0)]"
                  />
                  <p className="text-sm text-[#034863]/60 mt-1 font-['Poppins']">
                    Default: "Pre-Consultation Questionnaire"
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Let's Explore Your Goals"
                    className="font-['Poppins'] text-[18px] text-[rgb(0,0,0)]"
                  />
                  <p className="text-sm text-[#034863]/60 mt-1 font-['Poppins']">
                    Default: "Preliminary Consultation"
                  </p>
                </div>
                
                {/* Preview */}
                {(customTitle || customSubtitle) && (
                  <div className="mt-6 pt-6 border-t border-[#ddecf0]">
                    <p className="text-sm text-[#034863]/60 mb-3 font-['Poppins'] font-medium">Preview:</p>
                    <div className="bg-[#f5fafb] p-4 rounded-lg">
                      <h3 className="font-['Lora'] text-2xl text-[#034863] mb-1">
                        {displayTitle}
                      </h3>
                      <p className="font-['Poppins'] text-[18px] text-[#2f829b]">
                        {displaySubtitle}
                      </p>
                    </div>
                  </div>
